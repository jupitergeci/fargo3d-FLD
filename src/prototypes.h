...
ex void RadiationFLDFaceStep_cpu(real,real,Field*,Field*,Field*,Field*);
ex void RadiationFLDOperator_cpu(real,Field*,Field*,Field*,Field*);
ex void RadiationRKL2Update_cpu(real,real,real,real,real,real,Field*,Field*,Field*,Field*,Field*,Field*);
ex void RadiationSetDiffConstant_cpu(real,Field*);
ex void RadiationSetVariableTest_cpu(real,real,Field*,Field*);
ex void RadiationFLDFields_cpu(real,Field*,Field*,Field*,Field*,Field*,Field*);
ex void RadiationFLDDtField_cpu(real,Field*,Field*,Field*,Field*);
...
ex void RadiationOpacityTable_cpu(Field*,Field*,Field*);
ex void RadiationOpacityTableLoad(void);
ex void RadiationOpacityTableFree(void);
ex void RadiationDiffusion(real);
ex real RadiationDiffusionDt(real);
ex real RadiationFLDFaceDt(real,Field*,Field*,Field*);
ex int RadiationRKL2Stages(real,real);
ex int RadiationRKL2(real,real,real,Field*,Field*,Field*);
#endif
...
ex void FillBuffers(Field*, Buffer*, int, int, int, int, char*);
...
ex void _ComputeStar_cpu(real, int, int, int, int, int, int, int, int, int,
...
ex void _LorentzForce_cpu(real, int, int, int, int, int, int, int, int, int, int, int,
                          Field*, Field*,Field*, Field*,Field*);
ex void UpdateMagneticField(real, int, int, int);
ex void _UpdateMagneticField_cpu(real,int,int,int,int,int,int,int,int,int,Field*,Field*,Field*);
...
//Radiation GPU prototypes
#ifdef RADIATION
ex void RadiationDiffusionStep_gpu(real,real,Field*,Field*);
ex void RadiationDiffusionFLDStep_gpu(real,Field*,Field*,Field*);
ex void RadiationFLDFaceStep_gpu(real,real,Field*,Field*,Field*,Field*);
ex void RadiationFLDOperator_gpu(real,Field*,Field*,Field*,Field*);
ex void RadiationRKL2Update_gpu(real,real,real,real,real,real,Field*,Field*,Field*,Field*,Field*,Field*);
ex void RadiationSetDiffConstant_gpu(real,Field*);
ex void RadiationSetVariableTest_gpu(real,real,Field*,Field*);
ex void RadiationFLDFields_gpu(real,Field*,Field*,Field*,Field*,Field*,Field*);
ex void RadiationFLDDtField_gpu(real,Field*,Field*,Field*,Field*);
...
ex void RadiationOpacityTable_gpu(Field*,Field*,Field*);
#endif
...
ex void _ComputeStar_gpu(real, int, int, int, int, int, int, int, int, int,
                         Field*,Field*,Field*,Field*,Field*,Field*,Field*,Field*,Field*,Field*);
ex void _ComputeEmf_gpu(real,int,int,int,int,int,int,
                        Field*,Field*,Field*,Field*,Field*,Field*,Field*,Field*,Field*);
ex void _UpdateMagneticField_gpu(real,int,int,int,int,int,int,int,int,int,Field*,Field*,Field*);
ex void _LorentzForce_gpu(real, int, int, int, int, int, int, int, int, int, int, int,
                          Field*, Field*,Field*, Field*,Field*);
